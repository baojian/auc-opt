...
def run_parallel(dataset, num_cpus):
    ...
    list_methods = ['opt-auc-3d', 'lr', 'wei-lr', 'svm', 'wei-svm', 'ridge', 'wei-ridge', 'percep', 'wei-percep']
    ...
    pkl.dump(results_mat, open('results_3d_%02d_%s.pkl' % (data_ind[dataset], dataset), 'wb'))
